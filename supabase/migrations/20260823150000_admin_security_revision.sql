...
-- --------------------------------------------------------------------------
-- 12-13. Cierre y retiro no destructivo por publicación
-- Las funciones vigentes cerrar_publicacion y retirar_publicacion se
-- definen en la sección 15 y reciben (tabla, id).
