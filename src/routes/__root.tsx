...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AlertaVereda · Ebéjico, Antioquia" },
      {
        name: "description",
        content:
          "Plataforma comunitaria de prevención y alertas para las veredas rurales de Ebéjico.",
      },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {/* The splash stays mounted across route changes so login never reveals a blank frame. */}
      <AuthSplash />
